        ...
        <SectionContainer background="parchment" padding="lg">
            <div className="bg-white border border-gray-200 rounded-card p-8 shadow-sm">
                <div className="text-center mb-8">
                    <h2 className="text-h2 font-semibold font-serif text-gray-900 mb-3">
                        How It Works
                    </h2>
                    <p className="text-body/md text-gray-600 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {steps.map((step, index) => (
                        <div
                            key={index}
                            className="bg-orange-50 border border-orange-200 rounded-lg p-6 hover:shadow-md transition-all min-h-[160px] flex flex-col"
                        >
                            <div className="flex items-start gap-4 mb-3">
                                <div className="flex-shrink-0">
                                    <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-orange-100 border border-orange-200">
                                        {step.icon}
                                    </div>
                                </div>
