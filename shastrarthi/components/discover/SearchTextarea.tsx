...
export default function SearchTextarea({ initialQuery = "" }: { initialQuery?: string }) {
    const [query, setQuery] = useState(initialQuery);
    const [depth, setDepth] = useState<"standard" | "high" | "deep">("deep");
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
            <textarea
                ...
                className="w-full min-h-[94px] rounded-t-xl px-4 py-3 resize-none outline-none text-gray-800 placeholder:text-gray-400"
            />
