...
export default function LibraryPageClient({ initialData }: LibraryPageClientProps) {
    const [activeTab, setActiveTab] = useState<"saved" | "bookmarks" | "notes">("saved");
    const [isLoading, setIsLoading] = useState(false);
    const [libraryData, setLibraryData] = useState<LibraryData>(initialData);
                ...
                <section className="lg:col-span-2 bg-white border border-gray-200 rounded-xl shadow-sm p-4">
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            {activeTab === "bookmarks" && (
                                <BookmarksList bookmarks={libraryData.bookmarks} onRemove={removeBookmark} />
                            )}
