...
export const POST = withAuth(async (request, _context, { supabase, user }) => {
    ...
    try {
        ...
        const title = ((_a = body === null || body === void 0 ? void 0 : body.title) === null || _a === void 0 ? void 0 : _a.trim()) || "New chat";
        const agent = ((_b = body === null || body === void 0 ? void 0 : body.agent) === null || _b === void 0 ? void 0 : _b.trim()) || null;
        ...
        if (agent && agent.length > MAX_CHAT_THREAD_AGENT_LENGTH) {
            return NextResponse.json({ error: `Agent is too long. Maximum ${MAX_CHAT_THREAD_AGENT_LENGTH} characters allowed.` }, { status: 400 });
        }
        const { data, error } = await supabase
            .from("chat_threads")
            .insert({
