...
import { getCanonicalRedirect, hasSupabaseAuthCookie, isLocalhostHost, isProtectedAppRoute, } from "@/lib/routing";
...
export async function middleware(request) {
    ...
    const bypassAuthForE2E = process.env.E2E_AUTH_BYPASS === "1" && request.headers.get("x-e2e-auth") === "1";
