...
export default function PopularTasks() {
    return (<section className="bg-gray-50 py-14">
            ...
            return (<Link key={task.title} href={task.href} className="text-left bg-white rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all">
                ...
                <div className="mt-6 text-center">
                    <Link href="/app/gallery" className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
                        View Guru Gallery
