...
export default function TextResultsTable({ rows }) {
    ...
    return (<section className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {rows.map((row) => (<tr key={row.id} className="border-t border-gray-100 align-top">
                                <td className="p-3 min-w-[220px]">
                                    ...
                                    <div className="mt-2 flex items-center gap-2">
                                        ...
                                        <button onClick={() => void saveText(row.id)} disabled={savingId === row.id} className="text-gray-500 hover:text-gray-700 disabled:opacity-50">
