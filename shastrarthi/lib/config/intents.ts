...
export interface IntentItemConfig {
    id: string;
    label: string;
    value: string;
...
export interface IntentColumnConfig {
    title: string;
    items: IntentItemConfig[];
    expandedItems?: IntentItemConfig[];
}

export const INTENT_BUILDER_CONFIG: IntentColumnConfig[] = [
    {
        title: "I WANT TO",
        items: [
