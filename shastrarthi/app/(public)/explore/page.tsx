...
export const metadata: Metadata = {
    ...
    description:
        "Browse simplified and translated Shastra passages across languages, with contextual explanations generated on Shastrarthi.",
...
export default async function ExploreLandingPage() {
    ...
    type ExploreListItem = { slug: string; title: string; mode: "simplify" | "translate"; language: string };
    const { data } = supabase
        ? await supabase
              .from("public_pages")
              ...
              .limit(24)
        : { data: [] as ExploreListItem[] };
    const list = (data as ExploreListItem[] | null) ?? [];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {list.map((item) => (
                        <Link
                            ...
                            className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:border-orange-300 transition-colors"
                        >
